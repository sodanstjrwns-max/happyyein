...
> 서울 중구 시청역·명동·을지로 인근의 전문의 협진 치과. 통합치의학과 전문의 한승대 대표원장, 보존과 박미나 원장(연세대 석사·세브란스 수련), 교정과 박현미 원장 3인이 임플란트·신경치료·교정·심미치료를 직접 진료합니다. 발치즉시 임플란트(80% 이상 즉시식립), 미세현미경 신경치료, 투명교정(인비절라인)이 대표 진료입니다.
...
- **의료진**:
  ...
  - 박미나 원장 — 치과보존과 (연세대 치의학과 졸업, 연세대 보존과 석사, 세브란스 보존과 수련, 연세대 치과보존과 외래교수 역임, SCI 논문 등재) — 정밀 신경치료·근관치료·치아보존
...
- [치아보존치료·신경치료](${DOMAIN}/treatments/preservation): 보존과 담당 원장의 미세현미경 정밀 신경치료
