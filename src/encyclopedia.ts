...
export const terms: DentalTerm[] = [
  ...
  { id: 'microscope-treatment', term: '미세현미경 치료', termEn: 'Microscope-assisted Treatment', category: 'preservation', short: '미세현미경을 이용한 정밀 신경치료', desc: '미세현미경 치료는 10~25배 확대된 시야에서 근관(신경관)의 미세한 구조를 직접 보면서 치료하는 방법입니다. 육안으로 보이지 않는 추가 근관이나 파절선을 발견할 수 있어 치료 성공률을 크게 높입니다. 행복한예인치과 보존과 담당 원장가 시행합니다.', related: ['root-canal', 'endodontics', 'specialist'], treatmentLink: 'preservation' },
  { id: 'endodontics', term: '근관학', termEn: 'Endodontics', category: 'preservation', short: '치아 내부(근관)를 전문적으로 다루는 치의학 분야', desc: '근관학(근관치료학)은 치수와 근관 질환을 진단하고 치료하는 치의학의 전문 분야입니다. 신경치료, 재신경치료, 치근단 수술 등이 포함됩니다. 보존과 담당 원장가 이 분야를 전담합니다.', related: ['root-canal', 'pulp', 'specialist'], treatmentLink: 'preservation' },
