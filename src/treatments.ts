...
const treatments: TreatmentPage[] = [
  {
    ...
    faq: [
      ...
      { q: '명동·시청역 근처에서 임플란트 잘하는 치과를 찾고 있어요.', a: '행복한예인치과는 시청역 도보 5분, 명동역 도보 8분 거리에 위치한 임플란트 전문 치과입니다. 통합치의학과 전문의 한승대 원장이 80% 이상의 케이스에서 발치즉시 임플란트를 시행하며, 수요일 야간진료(20시)도 가능합니다. 을지로입구역 7분, 광화문역 10분, 회현역 6분 거리입니다. 전화 02-756-2828로 상담 예약해 주세요.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: '을지로·명동 근처에서 신경치료 잘하는 치과를 찾고 있어요.', a: '을지로입구역에서 도보 7분, 명동역에서 8분 거리에 있는 행복한예인치과에서는 보건복지부 인증 치과보존과 전문의 신정희 원장이 미세현미경을 활용한 정밀 신경치료를 직접 시행합니다. 시청역 5분, 회현역 6분, 광화문·종로에서도 10분 이내입니다. 전화 02-756-2828로 상담 예약해 주세요.' },
    ],
  },
  {
    slug: 'aesthetic',
  ...
  },
  {
    ...
    faq: [
      ...
      { q: '광화문·명동·종로 근처에서 교정 잘하는 치과를 찾고 있어요.', a: '행복한예인치과는 광화문역에서 도보 10분, 명동역 8분, 종로에서 10분 이내 거리에 위치합니다. 교정과 전문의 박현미 원장이 인비절라인 투명교정부터 설측교정까지 직접 진료합니다. 수요일 야간진료도 가능합니다. 전화 02-756-2828로 상담 예약해 주세요.' },
    ],
  },
  {
    slug: 'general',
    ...
    faq: [
      ...
      { q: '시청역·명동 근처에서 점심시간에 치과 치료를 받을 수 있나요?', a: '행복한예인치과는 시청역 도보 5분, 명동역 8분 거리에 위치하여 점심시간 내 방문이 가능합니다. 예약 시간을 철저히 지키고 대기 시간을 최소화하여 바쁜 직장인분들의 시간을 아껴드립니다. 수요일은 야간진료(20시까지)도 가능합니다. 전화 02-756-2828로 예약해 주세요.' },
    ],
  },
];
