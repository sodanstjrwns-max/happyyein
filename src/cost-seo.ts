...
export const costPages: CostPage[] = [
  {
    ...
    factors: [
      { title: '잔존 골량', desc: '뼈가 충분하면 골이식(잇몸뼈 이식) 없이 바로 식립 가능. 골이식(잇몸뼈 이식)이 필요하면 추가 비용이 발생합니다.', icon: 'fas fa-bone' },
      { title: '식립 위치', desc: '앞니/어금니, 상악/하악에 따라 난이도가 달라집니다. 상악동(위턱 공간) 거상술 필요 시 별도 안내.', icon: 'fas fa-tooth' },
      { title: '보철물(씌우는 치아) 종류', desc: '지르코니아, PFM 등 보철 재질에 따라 비용 차이. 내구성·심미성 기준으로 최적 추천.', icon: 'fas fa-crown' },
      { title: '추가 시술', desc: '발치, 골이식(잇몸뼈 이식), 상악동(위턱 공간) 거상술 등 동시 시행 여부에 따라 최종 비용이 결정됩니다.', icon: 'fas fa-plus-circle' },
    ],
    process: [
      ...
      { step: '치유 기간', desc: '2~4개월 골유착(뼈와 붙는 과정) 기간. 임시 보철로 심미성 유지.', cost: '추가 비용 없음' },
    ...
    faq: [
      ...
      { q: '골이식(잇몸뼈 이식) 비용은 별도인가요?', a: '골이식(잇몸뼈 이식)이 필요한 경우 별도 비용이 발생합니다. 다만 행복한예인치과에서는 발치즉시 임플란트 시 소량의 골이식(잇몸뼈 이식)은 기본 포함되는 경우가 많습니다. 정확한 비용은 CT 진단 후 안내합니다.' },
  ...
  },
  {
    ...
    treatment: '신경치료',
    title: '신경치료 비용 안내 | 행복한예인치과 보존과 담당 원장',
    metaDesc: '시청역·명동 신경치료 비용 안내. 보존과 담당 원장 미세현미경 신경치료. 건강보험 적용 항목. 자연치아 최대한 보존. 행복한예인치과 02-756-2828',
    keywords: '신경치료 비용, 신경치료 가격, 근관치료 비용, 시청역 신경치료, 명동 신경치료, 미세현미경 신경치료 비용',
    heroTitle: '신경치료 비용,<br>보험 적용부터 안내합니다',
    heroDesc: '보존과 박미나 원장의 미세현미경 정밀 신경치료. 건강보험 적용으로 부담을 줄여드립니다.',
    ...
    factors: [
      ...
      { title: '보철물(씌우는 치아) 종류', desc: '신경치료 후 크라운 재질(지르코니아, PFM, 금)에 따라 보철 비용이 달라집니다.', icon: 'fas fa-crown' },
    ...
    faq: [
      ...
      { q: '미세현미경 신경치료가 일반 치료보다 비싼가요?', a: '미세현미경 사용 자체에 추가 비용은 없습니다. 행복한예인치과에서는 보존과 담당 원장가 모든 신경치료에 미세현미경을 사용하며, 이는 치료 성공률을 크게 높입니다.' },
    ],
    relatedTreatments: ['implant-cost', 'aesthetic-cost'],
    ctaText: '신경치료 비용 상담 예약',
    doctor: '박미나 원장 (보존과, 연세대 석사)',
  },
  {
  ...
  },
  {
    ...
    factors: [
      ...
      { title: '기초 치료', desc: '신경치료, 코어(지대주(임플란트 기둥)) 포함 여부에 따라 총 비용 달라짐.', icon: 'fas fa-tools' },
    ],
    process: [
  ...
  },
  {
    ...
    whyUs: [
      '건강보험 적용으로 합리적 비용',
      '최소 침습 발치 — 통증·부종 최소화',
      '매복 사랑니 발치 13년 집당 — CT로 신경관 거리 확인 후 발치',
  ...
  },
  {
    ...
    whyUs: [
      '치료 전 기구를 직접 만져보게 하는 아이 적응 프로세스 운영',
