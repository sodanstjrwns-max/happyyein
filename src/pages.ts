...
export function doctorsPage(): string {
  const docFaq = [
    ...
    { q: '한승대 원장은 임플란트 경력이 어느 정도인가요?', a: '한승대 원장은 2013년 개원 이래 13년간 수천 건의 임플란트를 시술했습니다. 발치즉시 임플란트 80%+ 시행률, 상악동 거상술·골이식 등 고난이도 케이스까지 풍부한 경험을 보유하고 있습니다. NYU Implant Institute Course도 수료했습니다.' },
