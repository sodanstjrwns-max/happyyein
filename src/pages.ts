...
export function philosophyPage(): string {
  const philoFaq = [
    ...
    { q: '행복한예인치과가 추구하는 "환자 경험"이란 무엇인가요?', a: '단순히 질병을 치료하는 것이 아니라, 치과를 다녀간 뒤 "안도감"을 느끼실 수 있도록 하는 것입니다. 충분한 마취, 투명한 설명, 대기 시간 최소화, 사후 관리까지 전 과정에서 환자분의 편안함을 최우선으로 합니다.' },
    { q: '과잉 진료 여부를 어떻게 판단할 수 있나요?', a: '행복한예인치과에서는 X-ray와 CT 영상을 환자분과 함께 보면서 현재 상태를 투명하게 설명합니다. 치료가 필요한 부위와 그렇지 않은 부위를 명확히 구분하여 안내하며, 치료를 강요하지 않습니다. 다른 치과의 소견과 비교해 보셔도 됩니다.' },
    { q: '행복한예인치과의 직원 교육 철학은 어떤가요?', a: '모든 직원이 환자의 입장에서 생각하도록 교육합니다. 친절함뿐 아니라 전문성을 갖추기 위해 정기적인 내부 교육과 외부 세미나를 진행합니다. 원장부터 위생사까지 동일한 철학으로 환자분을 맞이합니다.' },
    { q: '시청역·명동 지역에 13년간 자리를 지킨 이유가 있나요?', a: '시청역·명동·을지로는 서울 도심 직장인 밀집 지역입니다. 이 곳의 직장인분들이 편하게 치과를 다닐 수 있도록 하는 것이 목표였고, 이전 없이 한 자리에서 꾸준히 신뢰를 쌓는 것이 저희의 경영 철학입니다.' },
...
<section class="sub-hero sub-hero-tall">
  <div class="sub-hero-bg">
    <img src="/static/img/dr-han-logo.webp" alt="행복한예인치과 진료 철학 - 시청역 명동 을지로 13년 신뢰의 치과" width="1200" height="800" loading="eager" fetchpriority="high">
  ...
  const physicianSchemas = [
    {
      ...
      "jobTitle": "대표원장",
      "description": "보건복지부 인증 통합치의학과 전문의, 치의학 박사. 발치즉시 임플란트, 고난이도 임플란트(상악동(위턱 공간) 거상술, 골이식(잇몸뼈 이식)), 전악 임플란트 재건, 앞니 심미 치료 전문.",
      ...
      "knowsAbout": ["발치즉시 임플란트", "상악동(위턱 공간) 거상술", "골이식(잇몸뼈 이식)", "전악 임플란트 재건", "앞니 심미 치료", "라미네이트", "레진"],
      "availableService": [
...
<section class="sub-hero sub-hero-tall">
  <div class="sub-hero-bg">
    <img src="/static/img/dr-han-front.webp" alt="행복한예인치과 의료진 - 통합치의학 보존과 교정과 전문의 3인" width="1200" height="800" loading="eager" fetchpriority="high">
    <div class="sub-hero-overlay"></div>
  </div>
  <div class="sub-hero-breadcrumb">
    <a href="/">Home</a>
  ...
  <div class="page-inner">
    ...
    <div class="doc-lead-grid rv">
      <div class="doc-lead-photo">
        <img src="/static/img/dr-han-profile.webp" alt="한승대 대표원장 - 통합치의학과 전문의 치의학 박사 경희대" width="400" height="533" loading="lazy">
      ...
      <div class="doc-lead-info">
        ...
        <div class="doc-creds-grid rv rv-d2">
          ...
          <div class="doc-cred-section">
            ...
            <ul>
              <li>발치즉시 임플란트</li>
              <li>고난이도 임플란트 (상악동(위턱 공간) 거상술, 골이식(잇몸뼈 이식))</li>
              <li>전악 임플란트 재건</li>
...
export function experiencePage(): string {
  const expFaq = [
    ...
    { q: '치과에서 울어도 괜찮나요?', a: '물론입니다. 치과 공포증은 매우 흔하며, 치료 중 긴장하거나 눈물이 나는 것은 전혀 부끄러운 일이 아닙니다. 행복한예인치과의 모든 직원은 환자분의 감정을 이해하고 존중하며, 편안한 분위기에서 치료받으실 수 있도록 최선을 다합니다.' },
    { q: '치료 중간에 쉬어가면서 할 수 있나요?', a: '물론입니다. 시술 중 불편하시거나 잠시 쉬고 싶으실 때 언제든 손을 들어 알려주세요. 바로 시술을 멈추고 편안해지실 때까지 기다립니다. 환자분의 페이스에 맞춰 진료하는 것이 원칙입니다.' },
    { q: '어르신(고령 환자)에 대한 배려가 있나요?', a: '어르신 환자분들을 위해 충분한 설명 시간을 확보하고, 큰 소리로 천천히 안내합니다. 보호자 동행 상담도 환영하며, 거동이 불편하신 분을 위해 접수·이동 시 도움을 드립니다. 65세 이상 임플란트 건강보험 적용도 안내해 드립니다.' },
    { q: '진료 후 궁금한 점이 생기면 어떻게 연락하나요?', a: '전화(02-756-2828)로 언제든 문의하실 수 있습니다. 진료 후 주의사항이나 증상 관련 질문에 친절하게 답변드리며, 필요한 경우 우선적으로 내원 예약을 잡아드립니다.' },
    { q: '행복한예인치과를 선택한 환자들의 공통적인 이유는?', a: '환자 리뷰에서 가장 많이 언급되는 키워드는 ①"생각보다 안 아팠다" ②"설명이 자세하다" ③"불필요한 치료를 권하지 않는다" ④"전문의가 직접 치료한다" ⑤"13년간 같은 자리" 입니다. 458건+ 리뷰 평균 4.9점이 이를 증명합니다.' },
    { q: '첫 방문 시 진료 과정이 어떻게 되나요?', a: '접수 → 문진표 작성 → X-ray 촬영 → 전문의 상담(X-ray 앞에서 현재 상태 설명) → 치료 계획 수립 → 치료 동의 후 시술 진행 순입니다. 상담만 받고 돌아가셔도 되며, 모든 과정에서 충분한 설명을 드립니다.' },
  ];
...
<section class="sub-hero sub-hero-tall">
  <div class="sub-hero-bg">
    <img src="/static/img/consult-2.webp" alt="행복한예인치과 환자 경험 - 편안한 진료 환경" width="1200" height="800" loading="eager" fetchpriority="high">
    <div class="sub-hero-overlay"></div>
  </div>
  <div class="sub-hero-breadcrumb">
    <a href="/">Home</a>
  ...
  <div class="page-inner">
    ...
    <div class="exp-pillar rv">
      <div class="exp-pillar-img">
        <img src="/static/img/consult-1.webp" alt="행복한예인치과 부드러운 진료 - 충분한 마취와 편안한 시술" width="600" height="400" loading="lazy">
      </div>
      <div class="exp-pillar-text">
        <div class="exp-pillar-num">01</div>
        <h3>Gentle Touch</h3>
        <h4>마취 주사 전 도포마취 적용 — 바늘 들어가는 순간부터 다릅니다</h4>
    ...
    <div class="exp-pillar exp-pillar-reverse rv">
      <div class="exp-pillar-img">
        <img src="/static/img/xray-2.webp" alt="행복한예인치과 명확한 소통 - X-ray 앞에서 투명한 설명" width="600" height="400" loading="lazy">
      </div>
      <div class="exp-pillar-text">
    ...
    <div class="exp-pillar rv">
      <div class="exp-pillar-img">
        <img src="/static/img/consult-3.webp" alt="행복한예인치과 효율적 시간 관리 - 직장인 맞춤 진료" width="600" height="400" loading="lazy">
      </div>
      <div class="exp-pillar-text">
    ...
    <div class="exp-pillar exp-pillar-reverse rv">
      <div class="exp-pillar-img">
        <img src="/static/img/treat-3.webp" alt="행복한예인치과 사후 케어 - 치료 후 지속적 관리" width="600" height="400" loading="lazy">
      </div>
      <div class="exp-pillar-text">
...
<section class="page-section bg-dark">
  <div class="page-inner">
    ...
    <div class="exp-gallery-grid">
      <div class="exp-gallery-item rv"><img src="/static/img/consult-1.webp" alt="행복한예인치과 상담실" width="600" height="450" loading="lazy"><span>상담실</span></div>
      <div class="exp-gallery-item rv rv-d1"><img src="/static/img/xray-1.webp" alt="행복한예인치과 X-ray 디지털 진단" width="600" height="450" loading="lazy"><span>X-ray 촬영</span></div>
      <div class="exp-gallery-item rv rv-d2"><img src="/static/img/treat-2.webp" alt="행복한예인치과 진료실" width="600" height="450" loading="lazy"><span>진료실</span></div>
      <div class="exp-gallery-item rv rv-d1"><img src="/static/img/xray-3.webp" alt="행복한예인치과 파노라마 정밀 진단" width="600" height="450" loading="lazy"><span>정밀 진단</span></div>
      <div class="exp-gallery-item rv rv-d2"><img src="/static/img/treat-6.webp" alt="행복한예인치과 치과 시술 장면" width="600" height="450" loading="lazy"><span>시술</span></div>
      <div class="exp-gallery-item rv rv-d3"><img src="/static/img/consult-3.webp" alt="행복한예인치과 사후 상담" width="600" height="450" loading="lazy"><span>사후 상담</span></div>
    </div>
  </div>
</section>
...
export function locationPage(): string {
  const locFaq = [
    ...
    { q: '행복한예인치과의 정확한 주소는 무엇인가요?', a: '서울특별시 중구 남대문로9길 51, 효덕빌딩 3층 301호입니다. 우편번호는 04530이며, 건물 1층에서 엘리베이터로 3층으로 올라오시면 됩니다.' },
    { q: '덕수궁 돌담길에서 가까운가요?', a: '네, 덕수궁 돌담길 남쪽 끝에서 도보 약 7~8분 거리입니다. 시청역 방향에서 남대문로9길로 접어들면 바로 행복한예인치과에 도착합니다.' },
    { q: '버스로 올 때 어디서 내리면 되나요?', a: '남대문시장 정류장에서 하차하시면 됩니다. 간선버스 402, 405, 501, 507번, 지선버스 7017, 7021번이 정차합니다. 정류장에서 도보 3~5분 거리입니다.' },
    { q: '우천 시 비를 맞지 않고 올 수 있는 경로가 있나요?', a: '시청역 지하보도를 이용하시면 비를 최소화할 수 있습니다. 시청역 4번·5번 출구에서 나와 약 5분 도보 거리이며, 주변에 아케이드나 건물 처마를 이용할 수 있는 경로도 있습니다.' },
    { q: '네비게이션에 뭐라고 검색하면 되나요?', a: '"행복한예인치과" 또는 "남대문로9길 51"로 검색하시면 정확하게 안내됩니다. 카카오맵, 네이버지도, 구글맵 모두에서 검색 가능합니다.' },
    { q: '엘리베이터가 있나요? 휠체어 접근이 가능한가요?', a: '효덕빌딩에 엘리베이터가 있어 3층까지 편하게 올라오실 수 있습니다. 휠체어나 유모차 이용 시에도 접근이 가능합니다. 도움이 필요하시면 사전에 전화(02-756-2828)로 알려주시면 준비하겠습니다.' },
    { q: '소공동·롯데백화점 근처에서 얼마나 걸리나요?', a: '소공동·롯데백화점(명동점)에서 도보 약 8분 거리입니다. 명동 거리를 지나 남대문 방향으로 오시면 쉽게 찾으실 수 있습니다. 쇼핑 전후 치과 방문이 편리합니다.' },
    { q: '서울 중구청에서 가까운가요?', a: '서울 중구청(태평로)에서 도보 약 10분, 대중교통으로 5분 이내입니다. 중구 행정 중심지에서 가까운 위치에 전문의 협진 치과가 있습니다.' },
  ];
...
<section class="sub-hero">
  <div class="sub-hero-bg">
    <img src="/static/img/dr-han-logo.webp" alt="행복한예인치과 오시는 길 - 서울 중구 남대문로 시청역 도보 5분" width="1200" height="800" loading="eager" fetchpriority="high">
    <div class="sub-hero-overlay"></div>
  </div>
  <div class="sub-hero-breadcrumb">
    <a href="/">Home</a>
