...
export const comparisons: ComparisonPage[] = [
  {
    ...
    optionA: {
      ...
      cons: ['수술 필요 (골이식(잇몸뼈 이식) 가능)', '치유 기간 2~4개월', '비보험 (65세 이상 일부 보험)', '골량 부족 시 추가 시술'],
  ...
  },
  {
    ...
    optionB: {
      name: '지연(기존) 임플란트',
      pros: ['감염 부위 완전 치유 후 식립 — 안정적', '골이식(잇몸뼈 이식) 후 충분한 골 형성 기간', '대부분의 환자에게 적용 가능'],
      cons: ['발치 후 3~6개월 대기', '내원 횟수 많음', '뼈·잇몸 위축 가능'],
      bestFor: '감염이 심한 경우, 골량 부족으로 골이식(잇몸뼈 이식) 필요한 분',
      link: '/treatments/implant',
    },
