...
| 2026-09-02 | **11차 (색인 개선 — 게시판 SSR 전환)** | **블로그/전후사진/공지 목록이 JS 렌더링이라 크롤러에 링크 0개 노출(고아 페이지) → 목록 완전 SSR 전환(D1 직접 조회 + 카드 그리드 + href 페이지네이션), 상세 페이지 하단 '함께 읽으면 좋은 글' 관련글 6개 내부링크 SSR 추가** |
| 2026-09-02 | **12차 (보존과 원장 교체: 신정희→박미나)** | **전 사이트 원장명 교체(50+개소, 13파일), 신규 약력 반영(연세대 치의학과 졸업·보존과 석사·세브란스 보존과 수련·연세대 치과보존과 외래교수·목동 예치과 보존과 과장·대한치과근관치료학회/대한치과보존학회 정회원·SCI 논문 J Endod 2014;40:182-6), Physician 스키마 #dr-park-mina 재작성, 의료광고 정확성 정비: '보존과 전문의'→'보존과 담당 원장', '박사' 표기 제거, '전문의 3인'→'원장 3인', 영어 페이지 Dr. Park Mina 반영** |
